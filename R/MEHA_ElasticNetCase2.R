...
#' @description This R function is written to solve the hyper-parameter selection problem of elastic net using the MEHA,
...
#' @param c \eqn{\underline{c}} in MEHA, which is used to generate the penalty parameter \eqn{c_k} in LV-HBA by \eqn{c_k = \underline{c}(k+1)^power}.
#'     Default is 10.
...
MEHA_ElasticnetCase2 = function(A_val, b_val, A_tr, b_tr, N = 500, alpha = 1e-3, beta = 1e-5, eta = 1e-5, gamma = 2, c = 10, power = 0.48, tol = 0.05, auto_tuning = FALSE, temperature = 0.1){
